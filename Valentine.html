<html>
    <body>
        ...
        <script>
            ...
            function showAlert() {
                alert("Yaaayyyyyy!!! Love ya! See you soon <3");
            }
            ...
            var noTexts = ["Are you sure?", "ARE YOU SURE?", "pweaaseee", "Pretty pleaseeee","Don't do this to me :(", "You're breaking my heart", "I'm gonna cry","I'm crying"];
            var imageSources = ["the-office-smile.gif", "date-mike.gif", "amy.gif", "sad-cry.gif"];
